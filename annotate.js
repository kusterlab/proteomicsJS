...
constants.GROUPS = {"neutral_n_terminal_group": constants.MASS["H"],
...
var terminal  ={
	...
	"z": {"offset": constants.GROUPS["neutral_c_terminal_group"] - constants.MASS["N"] - 2* constants.MASS["H"]}, "n-terminal": false}

var neutral_losses = [{
	"name":"h2o", "offset": -18.01528},
	{"name":"nh3", "offset": -	17.031},
	{"name":"co2", "offset": -	44.009}]


var f_apply_nl = function(sequence, neutral_losses){
...
var f_apply_modification = function(sequence, modifications){
	return sequence.reduce((prev, next) =>{
...
var f_get_masses = function(sequence, terminus, neutral_losses){
	...
	return sequence.reduce((prev, next, i) =>{
		...
		let mod_mass = next["modifications"].reduce((prev, modification) =>{
			return prev + modification["mass_monoisotopic"]
		}, 0);
		// no NL
...
var f_get_charges = function(mass_list, max_charge){
...
var f_apply_termini = function(){
	var blub = sequence.reduce((prev, next) =>{

	},[]);
}
var xyz = function(sequence, neutral_losses, termini){
	var blub = sequence.reduce((prev, next) =>{
	},[]);
